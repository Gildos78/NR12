	...
	},
	{
		...
		classMethods: {
			associate: function(models){
				...
				Laudo.hasMany(models.Intervencao, {foreignKey:'laudoId', sourceKey:'id'});
				Laudo.belongsToMany(models.NormaTecnica, {through:'NormatecnicaLaudo', foreignKey:'laudoId'});
				Laudo.belongsToMany(models.Manual, {through:'ManualLaudo', foreignKey:'laudoId'});
				Laudo.belongsToMany(models.InstalacoesDispEletrico, {through:'InstalacoesDispEletricoLaudo', foreignKey:'laudoId'});
				Laudo.belongsToMany(models.DisposicaoFinal, {through:'DisposicaoFinalLaudo', foreignKey:'laudoId'});
			}
		}
	});
	return Laudo;
