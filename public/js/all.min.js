...
(function() {
	...
	angular.module('myApp', ['ngStorage', 'ngRoute', 'ngResource', 'ngMessages', 'ui.bootstrap',
		...
		function config($routeProvider){
			...
			/* Miparl */
			$routeProvider.when('/miparls',{
				templateUrl: 'partials/miparl/listaMiparl.html',
				controller: 'listaMiparlController as controller',
                authorize: true
			});
			$routeProvider.when('/miparl',{
				templateUrl: 'partials/miparl/formMiparl.html',
				controller: 'formMiparlController as controller',
                authorize: true
			});
			$routeProvider.when('/miparl/:miparlId',{
				templateUrl: 'partials/miparl/formMiparl.html',
				controller: 'formMiparlController as controller',
                authorize: true
			});
			$routeProvider.when('/miparl/view/:miparlId',{
				templateUrl: 'partials/miparl/viewMiparl.html',
				controller: 'formMiparlController as controller',
                authorize: true
			});
			...
			/* Intervenções */
			$routeProvider.when('/intervencoes',{
				templateUrl: 'partials/intervencao/listaIntervencao.html',
				controller: 'listaIntervencaoController as controller',
                authorize: true
			});
			$routeProvider.when('/intervencao',{
				templateUrl: 'partials/intervencao/formIntervencao.html',
				controller: 'formIntervencaoController as controller',
                authorize: true
			});
			$routeProvider.when('/intervencao/:intervencaoId',{
				templateUrl: 'partials/intervencao/formIntervencao.html',
				controller: 'formIntervencaoController as controller',
                authorize: true
			});
			$routeProvider.when('/intervencao/view/:intervencaoId',{
				templateUrl: 'partials/intervencao/viewIntervencao.html',
				controller: 'formIntervencaoController as controller',
                authorize: true
			});

			/* Miparl 6.1 */
			$routeProvider.when('/miparls61',{
				templateUrl: 'partials/miparl61/listaMiparl61.html',
				controller: 'listaMiparl61Controller as controller',
                authorize: true
			});
			$routeProvider.when('/miparl61',{
				templateUrl: 'partials/miparl61/formMiparl61.html',
				controller: 'formMiparl61Controller as controller',
                authorize: true
			});
			$routeProvider.when('/miparl61/:miparl61Id',{
				templateUrl: 'partials/miparl61/formMiparl61.html',
				controller: 'formMiparl61Controller as controller',
                authorize: true
			});
			$routeProvider.when('/miparl61/view/:miparl61Id',{
				templateUrl: 'partials/miparl61/viewMiparl61.html',
				controller: 'formMiparl61Controller as controller',
                authorize: true
			});
				...
				/* Manuais */
				$routeProvider.when('/manuais',{
					templateUrl: 'partials/manual/listaManual.html',
					controller: 'listaManualController as controller',
					authorize: true
				});
				$routeProvider.when('/manual',{
					templateUrl: 'partials/manual/formManual.html',
					controller: 'formManualController as controller',
					authorize: true
				});
				$routeProvider.when('/manual/:manualId',{
					templateUrl: 'partials/manual/formManual.html',
					controller: 'formManualController as controller',
					authorize: true
				});
				$routeProvider.when('/manual/view/:manualId',{
					templateUrl: 'partials/manual/viewManual.html',
					controller: 'formManualController as controller',
					authorize: true
				});


				/* InstalacoesDispEletrico */
				$routeProvider.when('/instalacoesDispEletricos',{
					templateUrl: 'partials/instalacoesDispEletrico/listaInstalacoesDispEletrico.html',
					controller: 'listaInstalacoesDispEletricoController as controller',
					authorize: true
				});
				$routeProvider.when('/instalacoesDispEletrico',{
					templateUrl: 'partials/instalacoesDispEletrico/formInstalacoesDispEletrico.html',
					controller: 'formInstalacoesDispEletricoController as controller',
					authorize: true
				});
				$routeProvider.when('/instalacoesDispEletrico/:instalacoesDispEletricoId',{
					templateUrl: 'partials/instalacoesDispEletrico/formInstalacoesDispEletrico.html',
					controller: 'formInstalacoesDispEletricoController as controller',
					authorize: true
				});
				$routeProvider.when('/instalacoesDispEletrico/view/:instalacoesDispEletricoId',{
					templateUrl: 'partials/instalacoesDispEletrico/viewInstalacoesDispEletrico.html',
					controller: 'formInstalacoesDispEletricoController as controller',
					authorize: true
				});
			...
			/* DisposicoesFin */
			$routeProvider.when('/disposicaoFinais', {
				templateUrl : 'partials/disposicaoFinal/listaDisposicaoFinal.html',
				controller : 'listaDisposicaoFinalController as controller',
                authorize: true
			});
			$routeProvider.when('/disposicaoFinal',{
				templateUrl: 'partials/disposicaoFinal/formdisposicaoFinal.html',
				controller: 'formDisposicaoFinalController as controller',
                authorize: true
			});
			$routeProvider.when('/disposicaoFinal/:disposicaoFinalId',{
				templateUrl: 'partials/disposicaoFinal/formdisposicaoFinal.html',
				controller: 'formDisposicaoFinalController as controller',
                authorize: true
			});
			$routeProvider.when('/disposicaoFinal/view/:disposicaoFinalId',{
				templateUrl: 'partials/disposicaoFinal/viewDisposicaoFinal.html',
				controller: 'formDisposicaoFinalController as controller',
                authorize: true
			});
		...
		return {
			...
			link: function(scope,elm,attrs){
				...
				elm.bind('change',function(){
					...
					if (elm[0].id === "fotoit01"){
						if (elm[0].files.length > 0){
							scope.btnFotoIT01  = false;
						}else{
							scope.btnFotoIT01  = true;
						}
					}
...
(function() {
	...
	angular.module('myApp').factory('DisposicaoFinalFactory', function($resource){
	...
	var resource = $resource('/disposicaoFinal/:id', null, {
...
(function() {
	...
	angular.module('myApp').factory('SistemaSeguranca2Factory', function($resource){
		...
		var resource = $resource('/sistemaSeguranca2/:id', null, {
			'update':{
				method:'PUT'
			},
			'search':{
...
angular.module('myApp').factory('MipFactory',	function($resource){
	var factory = {
		get : fnGet,
		save : fnSave,
		update : fnUpdate,
...
var resource = $resource('/miparl/:id', null, {
...
angular.module('myApp').factory('IntervencaoFactory',	function($resource){
	var factory = {
		get : fnGet,
		save : fnSave,
		update : fnUpdate,
...
var resource = $resource('/intervencao/:id', null, {
...
angular.module('myApp').factory('Mip61Factory',	function($resource){
	var factory = {
		get : fnGet,
		save : fnSave,
		update : fnUpdate,
...
var resource = $resource('/miparl61/:id', null, {
...
angular.module('myApp').factory('ManualFactory',	function($resource){
	var factory = {
		get : fnGet,
		save : fnSave,
		update : fnUpdate,
...
var resource = $resource('/manual/:id', null, {
...
function selectOnlyThis1(value) {
...
function selectOnlyThis2(id, value) {
	alert(value);
...
angular.module('myApp').factory('InstalacoesDispEletricoFactory',	function($resource){
	var factory = {
		get : fnGet,
		save : fnSave,
		update : fnUpdate,
...
//	return $resource('/instalacoesDispEletricos/:id');

var resource = $resource('/instalacoesDispEletrico/:id', null, {
...
(function() {
	...
	Controller.$inject=['$http','$scope', '$routeParams', '$location', 'LaudoFactory', 'TipoDispositivoFactory', 'PerguntaFactory', 'ClienteFactory', 'MaquinaFactory', 'SistemaSegurancaFactory', 'SistemaSeguranca2Factory', 'LimiteMaquinaFactory', 'InstalacoesDispEletricoFactory', 'ManualFactory', 'MipFactory', 'IntervencaoFactory', 'Mip61Factory', 'NormaTecnicaFactory', 'DisposicaoFinalFactory', 'NormaRegFactory', 'PerigoFactory', 'RiscoFactory', '$uibModal', '$document',
    '$filter'];

	function Controller ($http, $scope, $routeParams, $location, LaudoFactory, TipoDispositivoFactory, PerguntaFactory, ClienteFactory, MaquinaFactory, LimiteMaquinaFactory, SistemaSegurancaFactory, SistemaSeguranca2Factory, InstalacoesDispEletricoFactory, MipFactory, IntervencaoFactory, ManualFactory, NormaTecnicaFactory, DisposicaoFinalFactory, Mip61Factory, NormaRegFactory, PerigoFactory, RiscoFactory, $uibModal, $document, $filter){
			...
			if($routeParams.laudoId){
				...
				.then(function(resp){
					if(resp.data){
						...
						atribuiImagemIntervencao();
						self.buscaMaquina();
						buscaNormaTecnica();
						buscaManual();
						buscaDisposicaoFinal();
						buscaInstalacoesDispEletrico();
		...
		function atribuiImagemIntervencao(){
			self.laudo.intervencoes.forEach(function(interv){
				if(interv.fotoit01 != undefined){
					interv.fotoit01 = {
						"show": "./laudos/"+self.laudo.id+"/intervencao/"+interv.id+"/fotoit01/"+interv.fotoit01
					}
				}
			});
		}
		...
		self.filtroIntervencao = "";

		self.novoIntervencao = function(){
			...
			var paramIntervencao = {
				animation:true,
				ariaLabelledBy: 'modal-title',
				ariaDescribedBy: 'modal-body',
				templateUrl: 'intervencoesModal.html',
				controller: 'formModalIntervencaoController',
				controllerAs: '$ctrl',
				size: 'lg',
				appendTo: parentElement,
				resolve:{
					intervencao: function(){
						return self.intervencao;
					}
				}
			};
			self.index = -1;
			var modalInstance = $uibModal.open(paramIntervencao);
			modalInstance.result.then(function(intervencao){
				self.laudo.intervencoes.push(intervencao);
			}, function(){
				self.index = -1;
			});
		};

		self.editaIntervencao = function(intervencao, x){
			var parentElement = angular.element($document[0].querySelector('.modal-demo .modal-parent'));
			var paramIntervencao = {
				animation:true,
				ariaLabelledBy: 'modal-title',
			...
			var modalInstance3 = $uibModal.open(paramIntervencao);
			modalInstance3.result.then(function(intervencao){
				self.laudo.intervencoes.splice(self.index, 1, intervencao);
		...
		self.removeIntervencao = function(intervencao, index){

			//debugger;
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa intervenção?",
				callback: function(confirma){
					//debugger;
					if (confirma) {

						if(self.laudo.destroyIntervencao == undefined){
							self.laudo.destroyIntervencao = [];
						}
						if(intervencao.id){
							self.laudo.destroyIntervencao.push(intervencao);
						}
						$scope.$apply(function(){

						self.laudo.intervencoes.splice(index, 1);
		...
		function buscaNormaTecnica(){
			DisposicaoFinalFactory.get().then(function(resp){
...
self.disposicaoFinalSelec ="";
self.disposicaoFinalSelec2 ="";


		function buscaDisposicaoFinal(){
			Mip61Factory.get().then(function(resp){
			
				if(resp.data){
					
					self.disposicaoFinais = resp.data;
					for(var x = 0; x < self.laudo.disposicaoFinais.length; x++){
						for(var i = 0; i< self.disposicaoFinais.length; i++){
							if(self.laudo.disposicaoFinais[x].id == self.disposicaoFinais[i].id){
								console.log(self.laudo);
								if(self.laudo.disposicaoFinais[x].id == 1){
									self.checked1 = true;
								}else if(self.laudo.disposicaoFinais[x].id == 2){
									self.checked2 = true;
								}else if(self.laudo.disposicaoFinais[x].id == 3){
									self.checked3 = true;
								}else if(self.laudo.disposicaoFinais[x].id == 4){
									self.checked4 = true;
								}else if(self.laudo.disposicaoFinais[x].id == 5){
									self.checked5 = true;
								}
							}
						}
		...
		self.adicionaDisposicaoFinal1 = function() {
			
			if(self.disposicaoFinalSelec.id == 1){
				removerPorId(self.laudo.disposicaoFinais, 2);
				removerPorId(self.laudo.disposicaoFinais, 3);
			}else if(self.disposicaoFinalSelec.id == 2){
				removerPorId(self.laudo.disposicaoFinais, 1);
				removerPorId(self.laudo.disposicaoFinais, 3);
			}else if(self.disposicaoFinalSelec.id == 3){
				removerPorId(self.laudo.disposicaoFinais, 1);
				removerPorId(self.laudo.disposicaoFinais, 2);
			};
			console.log(self.laudo);	
				
			self.laudo.disposicaoFinais.push(self.disposicaoFinalSelec);
			
			self.disposicaoFinais.DispFs = self.laudo.disposicaoFinais;
				
		};
		
		self.adicionaDisposicaoFinal2 = function() {
			
			if(self.disposicaoFinalSelec2.id == 4){
				removerPorId(self.laudo.disposicaoFinais, 5);
			}else if(self.disposicaoFinalSelec2.id == 5){
				removerPorId(self.laudo.disposicaoFinais, 4);
			};
				self.laudo.disposicaoFinais.push(self.disposicaoFinalSelec2);
		...
		self.removeDispF = function(dispF){
			for(var i = 0; i < self.laudo.disposicaoFinais.length; i++){
				if(self.laudo.disposicaoFinais[i].id == dispF.id){
					self.laudo.disposicaoFinais.splice(i,1);
					self.disposicaoFinais.push(dispF);
				}
			};
		};
...
self.manualSelec ="";
		...
		self.btnIncluirManu = true;

		self.changeManu = function(){
			self.btnIncluirManu = self.manualSelec ? false : true;
		}

		function buscaManual(){
			
			
			MipFactory.get().then(function(resp){
				
				if(resp.data){
					self.manuais = resp.data;
					for(var x = 0; x < self.laudo.manuais.length; x++){
						for(var i = 0; i< self.manuais.length; i++){
							if(self.laudo.manuais[x].id == self.manuais[i].id){
								self.manuais.splice(i,1);
							}
						}
					}
				}else{
		...
		self.adicionaManual = function() {
			for(var i = 0; i < self.manuais.length; i++){
				if(self.manuais[i].id == self.manualSelec.id){
					self.manuais.splice(i, 1);
				}
			};
			self.laudo.manuais.push(self.manualSelec);
			self.btnIncluirManu = true;
			self.manuais.Manus = self.laudo.manuais;
		};

		self.removeManual = function(manu){
			for(var i = 0; i < self.laudo.manuais.length; i++){
				if(self.laudo.manuais[i].id == manu.id){
					self.laudo.manuais.splice(i,1);
					self.manuais.push(manu);
				}
			};
		};
		...
		self.instalacoesDispEletricoSelec ="";

		self.btnIncluirInstalacao = true;

		self.changeInstalacao = function(){
			self.btnIncluirInstalacao = self.instalacoesDispEletricoSelec ? false : true;
		}

		function buscaInstalacoesDispEletrico(){
			InstalacoesDispEletricoFactory.get().then(function(resp){
				if(resp.data){
					console.log(resp.data);
					self.instalacoesDispEletricos = resp.data;
					for(var x = 0; x < self.laudo.instalacoesDispEletricos.length; x++){
						for(var i = 0; i< self.instalacoesDispEletricos.length; i++){
							if(self.laudo.instalacoesDispEletricos[x].id == self.instalacoesDispEletricos[i].id){
								self.instalacoesDispEletricos.splice(i,1);
							}
						}
					}
				}else{
					self.instalacoesDispEletricos = [];
				}
			});
		}

		self.adicionaInstalacoesDispEletrico = function() {
			for(var i = 0; i < self.instalacoesDispEletricos.length; i++){
				if(self.instalacoesDispEletricos[i].id == self.instalacoesDispEletricoSelec.id){
					self.instalacoesDispEletricos.splice(i, 1);
				}
			};
			self.laudo.instalacoesDispEletricos.push(self.instalacoesDispEletricoSelec);
			self.btnIncluirInstalacao = true;
			self.instalacoesDispEletricos.Instalacoes = self.laudo.instalacoesDispEletricos;
		};

		self.removeInstalacoesDispEletrico = function(instalacao){
			for(var i = 0; i < self.laudo.instalacoesDispEletricos.length; i++){
				if(self.laudo.instalacoesDispEletricos[i].id == mip.id){
					self.laudo.instalacoesDispEletricos.splice(i,1);
					self.instalacoesDispEletricos.push(mip);
				}
			};
		};
		...
		self.adicionaManual = function() {
			...
			self.manuais.Manu = self.laudo.manuais;
		...
		self.removeInstalacoesDispEletrico = function(instalacao){
			for(var i = 0; i < self.laudo.instalacoesDispEletricos.length; i++){
				if(self.laudo.instalacoesDispEletricos[i].id == instalacao.id){
					self.laudo.instalacoesDispEletricos.splice(i,1);
					self.instalacoesDispEletricos.push(instalacao);
				}
			};
		};
		...
		self.adicionaDisposicaoFinal = function() {
			for(var i = 0; i < self.disposicaoFinais.length; i++){
				if(self.disposicaoFinais[i].id == self.disposicaoFinalSelec.id){
					self.disposicaoFinais.splice(i, 1);
				}
			};
			self.laudo.disposicaoFinais.push(self.disposicaoFinalSelec);
			self.btnIncluirDispF = true;
			self.disposicaoFinais.DispFs = self.laudo.disposicaoFinais;
		};
		...
		$ctrl.buscaPerguntas = function (){
			TipoDispositivoFactory.get($ctrl.dispositivo.tipoDispositivoId).then(function(resp){
				if(resp.data){
					...
					$ctrl.dispositivo.tipoDispositivo = [];
					
					$ctrl.dispositivo.tipoDispositivo.push(resp.data);
				}
			});
		};
...
(function(){
	...
	angular.module('myApp').controller('formModalIntervencaoController', Controller);

	Controller.$inject=['$http', '$scope', '$routeParams','PerigoFactory', 'SistemaSegurancaFactory','SistemaSeguranca2Factory', 'MipFactory', 'Mip61Factory', 'RiscoFactory', '$uibModalInstance', 'intervencao'];

	function Controller ($http, $scope, $routeParams, PerigoFactory, SistemaSegurancaFactory, SistemaSeguranca2Factory, MipFactory, Mip61Factory, RiscoFactory , $uibModalInstance, intervencao){

		//inicia os botões de upload.
		$scope.btnFotoIT01 = true;	
		$scope.selFotoIT01 = false;

		var $ctrl = this;
		$ctrl.intervencao = null;
		

		$ctrl.salvarIntervencao = function(){
			$uibModalInstance.close($ctrl.intervencao);
		};

		$ctrl.cancelarIntervencao = function(){
			$uibModalInstance.dismiss('cancel');
		};

		$ctrl.init = function(){
			$ctrl.intervencao = intervencao;
			buscaPerigos();
			listaRiscos();
		...
		/******************BUSCA MIPARL*************************/
		function buscaMiparls(){
			MipFactory.get().then(function(resp){
				if(resp.data){
					$ctrl.miparls = resp.data;
					for(var x = 0; x < $ctrl.intervencao.Miparls.length; x++){
						for(var i = 0; i< $ctrl.miparls.length; i++){
							if($ctrl.intervencao.Miparls[x].id == $ctrl.miparls[i].id){
								$ctrl.miparls.splice(i,1);
							}
						}
					}
				}else{
		...
		/****************************ADICIONA MIPARL***********************************/
		$ctrl.adicionaMiparl = function(){

			for(var i = 0; i < $ctrl.miparls.length; i++){
				if($ctrl.miparls[i].id == $ctrl.miparlSelecionado.id){
					$ctrl.miparls.splice(i, 1);
				}
			}
			$ctrl.intervencao.Miparls.push($ctrl.miparlSelecionado);
			$ctrl.miparlSelecionado = "";

		};

		/******************BUSCA MIPARL 6.1*************************/
		function buscaMiparls61(){
			Mip61Factory.get().then(function(resp){
				if(resp.data){
					console.log(resp.data);
					$ctrl.miparls61 = resp.data;
					for(var x = 0; x < $ctrl.intervencao.miparls61.length; x++){
						for(var i = 0; i< $ctrl.miparls61.length; i++){
							if($ctrl.intervencao.miparls61[x].id == $ctrl.miparls61[i].id){
								$ctrl.miparls61.splice(i,1);
							}
						}
					}
				}else{
		...
		/****************************ADICIONA MIPARL***********************************/
		$ctrl.adicionaMiparl61 = function(){

			for(var i = 0; i < $ctrl.miparls61.length; i++){
				if($ctrl.miparls61[i].id == $ctrl.miparl61Selecionado.id){
					$ctrl.miparls61.splice(i, 1);
				}
			}
			console.log($ctrl.intervencao);
			$ctrl.intervencao.miparls61.push($ctrl.miparl61Selecionado);
			$ctrl.miparl61Selecionado = "";
		...
		function buscaPerigos(){
			PerigoFactory.get().then(function(resp){
				if(resp.data){
					...
					for(var x = 0; x < $ctrl.intervencao.Perigos.length; x++){
						for(var i = 0; i< $ctrl.perigos.length; i++){
							if($ctrl.intervencao.Perigos[x].id == $ctrl.perigos[i].id){
		...
		$ctrl.adicionaPerigo = function(){
			...
			$ctrl.intervencao.Perigos.push($ctrl.perigoSelecionado);
			$ctrl.perigoSelecionado = "";

			listaRiscos();
		};

		/******************BUSCA SISTEMA SEGURANÇA*************************/
		function buscaSistemasSeguranca(){
			SistemaSegurancaFactory.get().then(function(resp){
				if(resp.data){
					console.log($ctrl.intervencao);
					$ctrl.sistemasSeguranca = resp.data;
					for(var x = 0; x < $ctrl.intervencao.SistemaSegurancas.length; x++){
						for(var i = 0; i< $ctrl.sistemasSeguranca.length; i++){
							if($ctrl.intervencao.SistemaSegurancas[x].id == $ctrl.sistemasSeguranca[i].id){
								$ctrl.sistemasSeguranca.splice(i,1);
							}
						}
					}
					for(var x = 0; x < $ctrl.intervencao.SistemaSeguranca2s.length; x++){
						for(var i = 0; i< $ctrl.sistemasSeguranca.length; i++){
							if($ctrl.intervencao.SistemaSeguranca2s[x].id == $ctrl.sistemasSeguranca[i].id){
								$ctrl.sistemasSeguranca.splice(i,1);
							}
						}
					}
		...
		/****************************ADICIONA SISTEMA SEGURANCA***********************************/
		$ctrl.adicionaSistemaSeguranca = function(){

			for(var i = 0; i < $ctrl.sistemasSeguranca.length; i++){
				if($ctrl.sistemasSeguranca[i].id == $ctrl.sistemaSegurancaSelecionado.id){
					$ctrl.sistemasSeguranca.splice(i, 1);
				}
			}
		
			$ctrl.intervencao.SistemaSegurancas.push($ctrl.sistemaSegurancaSelecionado);
			$ctrl.sistemaSegurancaSelecionado = "";

			
		};

		$ctrl.adicionaSistemaSeguranca2 = function(){

			for(var i = 0; i < $ctrl.sistemasSeguranca.length; i++){
				if($ctrl.sistemasSeguranca[i].id == $ctrl.sistemaSegurancaSelecionado2.id){
					$ctrl.sistemasSeguranca.splice(i, 1);
				}
			}
			$ctrl.intervencao.SistemaSeguranca2s.push($ctrl.sistemaSegurancaSelecionado2);
			$ctrl.sistemaSegurancaSelecionado2 = "";
		...
		$ctrl.adicionaRisco = function(){
			...
			$ctrl.intervencao.Riscos.push($ctrl.riscoSelecionado);
		...
		function listaRiscos(){
			$ctrl.riscos = [];
			for(var i = 0; i < $ctrl.intervencao.Perigos.length; i++){
				for(var x = 0; x < $ctrl.intervencao.Perigos[i].Riscos.length; x++){
					var contem = false;
				      // verifica sem ja tem o risco na lista de riscos
				      for(var y = 0; y < $ctrl.riscos.length; y++){
				      	if($ctrl.riscos[y] != undefined && $ctrl.riscos[y].id == $ctrl.intervencao.Perigos[i].Riscos[x].id){
				      		contem = true;
				      	}
				      }
				      // verificar se o risco ja esta cadastrado no intervencoes
				      for(var z = 0; z < $ctrl.intervencao.Riscos.length; z++){
				      	if($ctrl.intervencao.Riscos[z].id == $ctrl.intervencao.Perigos[i].Riscos[x].id){
				      		contem = true;
				      	}
				      }
				      if(!contem){
				      	console.log("adiciona");
				      	$ctrl.riscos.push($ctrl.intervencao.Perigos[i].Riscos[x]);
				      }
				  }
				}
			}

			/********************* REMOVE SISTEMA SEGURANCA ***********************************************/
			$ctrl.removeSistemaSeguranca = function(sistemaSeguranca){
				for(var i = 0; i < $ctrl.intervencao.SistemaSegurancas.length; i++){
					if($ctrl.intervencao.SistemaSegurancas[i].id == sistemaSeguranca.id){
						$ctrl.intervencao.SistemaSegurancas.splice(i, 1);
						$ctrl.sistemasSeguranca.push(sistemaSeguranca);
					}
				}
			};

			$ctrl.removeSistemaSeguranca2 = function(sistemaSeguranca){
				for(var i = 0; i < $ctrl.intervencao.SistemaSeguranca2s.length; i++){
					if($ctrl.intervencao.SistemaSeguranca2s[i].id == sistemaSeguranca.id){
						$ctrl.intervencao.SistemaSeguranca2s.splice(i, 1);
						$ctrl.sistemasSeguranca.push(sistemaSeguranca);
					}
				}
			}
			...
			$ctrl.removePerigo = function(perigo){
				for(var i = 0; i < $ctrl.intervencao.Perigos.length; i++){
					if($ctrl.intervencao.Perigos[i].id == perigo.id){
						$ctrl.intervencao.Perigos.splice(i, 1);
			...
			$ctrl.removeRisco = function(risco){
				for(var i = 0; i < $ctrl.intervencao.Riscos.length; i++){
					if($ctrl.intervencao.Riscos[i].id == risco.id){
						$ctrl.intervencao.Riscos.splice(i, 1);
			...
			/********************* REMOVE MIPARL ***********************************************/
			$ctrl.removeMiparl = function(miparl){
				for(var i = 0; i < $ctrl.intervencao.Miparls.length; i++){
					if($ctrl.intervencao.Miparls[i].id == miparl.id){
						$ctrl.intervencao.Miparls.splice(i, 1);
						$ctrl.miparls.push(miparl);
					}
				}
			};

			/********************* REMOVE MIPARL 61 ***********************************************/
			$ctrl.removeMiparl61 = function(miparl61){
				for(var i = 0; i < $ctrl.intervencao.miparls61.length; i++){
					if($ctrl.intervencao.miparls61[i].id == miparl61.id){
						$ctrl.intervencao.miparls61.splice(i, 1);
						$ctrl.miparls61.push(miparl61);
					}
				}
			};
			...
			$ctrl.uploadIntervencao = function(nomeFoto){

				var fd = new FormData();
				//Fotoit01
				if ($scope.fotoit01 !== undefined){
					angular.forEach($scope.fotoit01, function(file){
						console.log(file);
						fd.append('file',file);
					})
					$scope.fotoit01 = undefined;
					$ctrl.postUpload(fd, nomeFoto);
					$scope.btnFotoIT01 = true;
				}
...
(function() {
	...
	function Controller($routeParams, $location, NormaTecnicaFactory){
		...
		self.remove = function(normaTecnica){
			bootbox.confirm({
				size: 'small',
				message: 'Deseja excluir esta norma técnica',
				callback: function(confirma){
					if(confirma){
...
(function() {
	...
	(function() {
		...
		angular.module('myApp').controller('formDisposicaoFinalController', Controller);
	
		Controller.$inject=['$routeParams', '$location', 'DisposicaoFinalFactory'];
	
		function Controller($routeParams, $location, DisposicaoFinalFactory){
			var self = this;
	
			self.init = function(){
				if($routeParams.disposicaoFinalId){
					DisposicaoFinalFactory.get($routeParams.disposicaoFinalId)
					.then(function(resp){
						if(resp.data){
					...
					self.disposicaoFinal = {};
				}
			};
			self.salva = function(){
				if(!self.disposicaoFinal.id){
					save();
				}else{
						update();
				}
			...
			function save(){
				DisposicaoFinalFactory.save(self.disposicaoFinal)
				.then(function(resp){
					if(resp.data){
						self.disposicaoFinal = {};
						$location.path('/disposicaoFinais');
					}
				}).catch(function(erro){
						 console.log(erro);
						 function retornaMsg(data){
			...
			function update(){
				var _id = self.disposicaoFinal.id;
				console.log(self.disposicaoFinal);
				DisposicaoFinalFactory.update(_id, self.disposicaoFinal)
				.then(function(){
					self.mensagem = {texto: 'salvo com sucesso'};
					$location.path('/disposicaoFinais');
				}).catch(function(erro){
			...
			self.remove = function(disposicaoFinal){
				bootbox.confirm({
					size: 'small',
					message: 'Deseja excluir esta disposição final?',
					callback: function(confirma){
						if(confirma){
							DisposicaoFinalFactory.remove(disposicaoFinal.id)
							.then(function(data){
								$location.path('/disposicaoFinais')
							});
						}
	...
	(function() {
		...
		angular.module('myApp').controller('listaDisposicaoFinalController', Controller);
	
		Controller.$inject=['DisposicaoFinalFactory'];
	
		function Controller(DisposicaoFinalFactory){
			...
			self.init = function(){
				buscaDisposicaoFinais();
			};
	
			function buscaDisposicaoFinais(){
				DisposicaoFinalFactory.get().then(function(resp){
					if(resp.data){
						self.disposicaoFinais = resp.data;
					}
			...
			self.remove = function(disposicaoFinal){
					bootbox.confirm({
					size: 'small',
					message: 'Deseja deletar essa disposição final?',
					callback: function(confirma){
						if(confirma){
							DisposicaoFinalFactory.remove(disposicaoFinal.id)
							.then(function(data){
...
(function() {
	...
	angular.module('myApp').controller('formMiparlController', Controller);

	Controller.$inject=['$routeParams', '$resource', '$location', 'MipFactory'];

	function Controller($routeParams, $resource, $location, ManualFactory){

		var self = this;
		self.init = function(){

			if($routeParams.miparlId){
				ManualFactory.get($routeParams.miparlId)
				.then(function(resp){
					if(resp.data){
							self.miparl = resp.data;
							console.log(self.miparl);
					}
				})
				.catch(function(erro){
					self.mensagem = {
						text: 'Esta informação não existe. Nova informação será incluida'
					};
				}
			);
			}else{
		...
		function save(){
			ManualFactory.save(self.miparl)
			.then(function(resp){
				  if(resp.data){

					self.miparl = {};
					$location.path('/miparls');
				}
			})
			.catch(function(erro){
				 console.log(erro);
		...
		self.remove = function(miparl){
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa informação?",
				callback: function(confirma){
					if (confirma) {
						ManualFactory.remove(miparl.id)
		...
		function update(){
			...
			ManualFactory.update(self.miparl.id, self.miparl)
			.then(function(){
...
(function() {
	...
	angular.module('myApp').controller('listaMiparlController', Controller);

	Controller.$inject=['MipFactory'];

	function Controller(MipFactory){
		...
		function buscaMiparl(){
			MipFactory.get().then(function(resp){

				if(resp.data){
					self.miparls = resp.data;
		...
		self.remove = function(miparl){
		  bootbox.confirm({
			  size: 'small',
			  message: "Deseja deletar esta informação ?",
			  callback: function(confirma){
					if (confirma){
						MipFactory.remove(miparl.id)
							.then(function(data){
								buscaMiparl();
							});
						}
...
(function() {
	...
	angular.module('myApp').controller('formIntervencaoController', Controller);

	Controller.$inject=['$routeParams', '$resource', '$location', 'IntervencaoFactory'];

	function Controller($routeParams, $resource, $location, IntervencaoFactory){

		var self = this;
		self.init = function(){

			if($routeParams.intervencaoId){
				IntervencaoFactory.get($routeParams.intervencaoId)
				.then(function(resp){
					if(resp.data){
							self.intervencao = resp.data;
							console.log(self.intervencao);
					}
				})
				.catch(function(erro){
					self.mensagem = {
		...
		function save(){
			IntervencaoFactory.save(self.intervencao)
			.then(function(resp){
				  if(resp.data){

					self.intervencao = {};
					$location.path('/intervencoes');
				}
			})
			.catch(function(erro){
				 console.log(erro);
		...
		self.remove = function(intervencao){
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa informação?",
				callback: function(confirma){
					if (confirma) {
						IntervencaoFactory.remove(intervencao.id)
		...
		function update(){
			...
			IntervencaoFactory.update(self.intervencao.id, self.intervencao)
			.then(function(){
...
(function() {
	...
	angular.module('myApp').controller('listaIntervencaoController', Controller);

	Controller.$inject=['IntervencaoFactory'];

	function Controller(IntervencaoFactory){
		...
		function buscaIntervencao(){
			IntervencaoFactory.get().then(function(resp){

				if(resp.data){
					self.intervencoes = resp.data;
...
(function() {
	...
	angular.module('myApp').controller('formMiparl61Controller', Controller);

	Controller.$inject=['$routeParams', '$resource', '$location', 'Mip61Factory'];

	function Controller($routeParams, $resource, $location, Mip61Factory){

		var self = this;
		self.init = function(){

			if($routeParams.miparl61Id){
				Mip61Factory.get($routeParams.miparl61Id)
				.then(function(resp){
					if(resp.data){
							self.miparl61 = resp.data;
							console.log(self.miparl61);
					}
				})
				.catch(function(erro){
					self.mensagem = {
		...
		function save(){
			Mip61Factory.save(self.miparl61)
			.then(function(resp){
				  if(resp.data){

					self.miparl61 = {};
					$location.path('/miparls61');
				}
			})
			.catch(function(erro){
				 console.log(erro);
		...
		self.remove = function(miparl61){
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa informação?",
				callback: function(confirma){
					if (confirma) {
						Mip61Factory.remove(miparl61.id)
		...
		function update(){
			...
			Mip61Factory.update(self.miparl61.id, self.miparl61)
			.then(function(){
...
(function() {
	...
	angular.module('myApp').controller('listaMiparl61Controller', Controller);

	Controller.$inject=['Mip61Factory'];

	function Controller(Mip61Factory){
		...
		function buscaMiparl61(){
			Mip61Factory.get().then(function(resp){

				if(resp.data){
					self.miparls61 = resp.data;
...
(function() {
	...
	angular.module('myApp').controller('formManualController', Controller);

	Controller.$inject=['$routeParams', '$location', 'ManualFactory'];

	function Controller($routeParams, $location, ManualFactory){

		var self = this;
		self.init = function(){

			if($routeParams.manualId){
				ManualFactory.get($routeParams.manualId)
				.then(function(resp){
					if(resp.data){
							self.manual = resp.data;
		...
		function save(){
			ManualFactory.save(self.manual)
			.then(function(resp){
				  if(resp.data){

					self.manual = {};
					$location.path('/manuais');
				}
			})
			.catch(function(erro){
				 console.log(erro);
		...
		self.remove = function(manual){
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa informação?",
				callback: function(confirma){
					if (confirma) {
						ManualFactory.remove(manual.id)
		...
		function update(){
			...
			ManualFactory.update(self.manual.id, self.manual)
			.then(function(){
...
(function() {
	...
	angular.module('myApp').controller('listaManualController', Controller);

	Controller.$inject=['ManualFactory'];

	function Controller(ManualFactory){
		...
		function buscaManual(){
			ManualFactory.get().then(function(resp){
...
(function() {
	...
	angular.module('myApp').controller('formInstalacoesDispEletricoController', Controller);

	Controller.$inject=['$routeParams', '$location', 'InstalacoesDispEletricoFactory'];

	function Controller($routeParams, $location, InstalacoesDispEletricoFactory){

		var self = this;
		self.init = function(){

			if($routeParams.instalacoesDispEletricoId){
				InstalacoesDispEletricoFactory.get($routeParams.instalacoesDispEletricoId)
				.then(function(resp){
					if(resp.data){
							self.instalacoesDispEletrico = resp.data;
							console.log(self.instalacoesDispEletrico);
					}
				})
				.catch(function(erro){
					self.mensagem = {
		...
		self.salva = function(){
			if(!self.instalacoesDispEletrico.id){
		  	save();
			}else{
				update();
			}
		...
		function save(){
			InstalacoesDispEletricoFactory.save(self.instalacoesDispEletrico)
			.then(function(resp){
				  if(resp.data){

					self.instalacoesDispEletrico = {};
					$location.path('/instalacoesDispEletricos');
				}
			})
			.catch(function(erro){
				 console.log(erro);
		...
		self.remove = function(instalacoesDispEletrico){
			bootbox.confirm({
				size: 'small',
				message: "Deseja deletar essa informação?",
				callback: function(confirma){
					if (confirma) {
						InstalacoesDispEletricoFactory.remove(instalacoesDispEletrico.id)
		...
		function update(){
			...
			InstalacoesDispEletricoFactory.update(self.instalacoesDispEletrico.id, self.instalacoesDispEletrico)
			.then(function(){
...
(function() {
	...
	angular.module('myApp').controller('listaInstalacoesDispEletricoController', Controller);

	Controller.$inject=['InstalacoesDispEletricoFactory'];

	function Controller(InstalacoesDispEletricoFactory){
