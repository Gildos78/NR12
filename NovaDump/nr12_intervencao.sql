...
CREATE TABLE `intervencao` (
  ...
  `fotoit01` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_intervencao_laudo1_idx` (`laudoId`),
  CONSTRAINT `fk_intervencao_laudo1` FOREIGN KEY (`laudoId`) REFERENCES `laudo` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `intervencao` VALUES (76,'teste',92,NULL);
